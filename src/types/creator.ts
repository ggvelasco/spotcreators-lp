...
export const creators: Creator[] = [
  {
    ...
    handle: "@patifeptf",
    tags: "Games • Humor",
    img: "/influencers/patife.jpg",
    location: "São Paulo, SP",
    bio: `Patife é um criador de conteúdo brasileiro especializado em games e cultura pop. Conhecido por seu humor autêntico e carisma, ele conquistou milhares de seguidores com suas gameplays divertidas, reações engraçadas e conteúdo descontraído. Patife se destaca pela sua interação com o público, criando uma comunidade engajada e apaixonada por games.​`,
    topics: ["Games", "Humor", "Cultura Pop", "E-Sports"],
    social: {
      instagram: 259000,
      tiktok: 42900,
      youtube: 2460000,
  ...
  },
  {
    name: "Nick",
    handle: "@nickbgg",
    tags: "Games • Jogos de tabuleiro",
    img: "/influencers/nick.jpg",
    location: "São Paulo, SP",
    bio: `Nickolas Sanches, conhecido como NickBGG, é um criador de conteúdo brasileiro especializado em jogos de tabuleiro, card games e board games. Com um público engajado, ele compartilha gameplays, análises, curiosidades e recomendações de jogos, tornando-se uma referência na comunidade de board games no Brasil.​`,
    topics: ["Games", "Jogos de tabuleiro"],
    social: {
      instagram: 259000,
      tiktok: 350800,
      youtube: 36600,
